        ...
        <div className="container mx-auto px-4 pt-32 pb-16 md:pt-40 md:pb-20 relative z-10">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#1da851] text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
            >
