...
import { Download, ArrowRight, Home, Building, TreePine, Dumbbell } from "lucide-react";
...
const cityData: Record<string, { name: string; metaTitle: string; metaDesc: string; intro: string; activities: { name: string; slug: string }[] }> = {
  ...
  "mississauga": { name: "Mississauga", metaTitle: "Personal Trainer Mississauga | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Mississauga at your location.", intro: "Mississauga demand often leans toward Strength & Conditioning, HIIT, and Bootcamp—popular for busy schedules and efficient full-body sessions.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Yoga", slug: "yoga" }, { name: "Boxing", slug: "boxing" }, { name: "Kickboxing", slug: "kickboxing" }] },
  "vancouver": { name: "Vancouver", metaTitle: "Personal Trainer Vancouver | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Vancouver at your location.", intro: "Vancouver bookings commonly blend Yoga and Strength & Conditioning, with HIIT and Calisthenics popular for park-friendly sessions.", activities: [{ name: "Yoga", slug: "yoga" }, { name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "HIIT", slug: "hiit" }, { name: "Calisthenics", slug: "calisthenics" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }] },
  "calgary": { name: "Calgary", metaTitle: "Personal Trainer Calgary | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Calgary at your location.", intro: "Calgary customers often book Strength & Conditioning plus HIIT/Bootcamp for conditioning, and Boxing/Self Defense for skill-based fitness.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }, { name: "Self Defense", slug: "self-defense" }, { name: "Kickboxing", slug: "kickboxing" }] },
  "edmonton": { name: "Edmonton", metaTitle: "Personal Trainer Edmonton | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Edmonton at your location.", intro: "Edmonton bookings often focus on Strength & Conditioning for steady progress, with Yoga for mobility and Boxing/HIIT for conditioning.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Yoga", slug: "yoga" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }, { name: "Calisthenics", slug: "calisthenics" }] },
  "winnipeg": { name: "Winnipeg", metaTitle: "Personal Trainer Winnipeg | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Winnipeg at your location.", intro: "Winnipeg customers often choose Strength & Conditioning and Bootcamp for general fitness, with Yoga as a strong complement for mobility.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "HIIT", slug: "hiit" }, { name: "Yoga", slug: "yoga" }, { name: "Boxing", slug: "boxing" }, { name: "Kickboxing", slug: "kickboxing" }] },
  "ottawa": { name: "Ottawa", metaTitle: "Personal Trainer Ottawa | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Ottawa at your location.", intro: "Ottawa customers frequently book Strength & Conditioning for progress, with Yoga and Calisthenics for mobility and bodyweight-focused sessions.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Yoga", slug: "yoga" }, { name: "Calisthenics", slug: "calisthenics" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }] },
  "quebec-city": { name: "Quebec City", metaTitle: "Personal Trainer Quebec City | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Quebec City at your location.", intro: "Quebec City customers often lean toward Yoga and Strength & Conditioning, with HIIT popular for efficient conditioning sessions.", activities: [{ name: "Yoga", slug: "yoga" }, { name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }, { name: "Kickboxing", slug: "kickboxing" }] },
  "halifax": { name: "Halifax", metaTitle: "Personal Trainer Halifax | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Halifax at your location.", intro: "Halifax customers often book Bootcamp/HIIT for group-friendly conditioning and Strength & Conditioning for steady progress.", activities: [{ name: "Bootcamp", slug: "bootcamp" }, { name: "HIIT", slug: "hiit" }, { name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Yoga", slug: "yoga" }, { name: "Boxing", slug: "boxing" }, { name: "Kickboxing", slug: "kickboxing" }] },
  "fredericton": { name: "Fredericton", metaTitle: "Personal Trainer Fredericton | In-Person Training | Group Fit", metaDesc: "Book in-person personal training in Fredericton at your location.", intro: "Fredericton customers often combine Strength & Conditioning and Yoga for balanced training—strength, mobility, and consistency.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Yoga", slug: "yoga" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }, { name: "Calisthenics", slug: "calisthenics" }] },
  "saskatoon": { name: "Saskatoon", metaTitle: "Personal Trainer Saskatoon | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Saskatoon at your location.", intro: "Saskatoon demand often centers on Strength & Conditioning and Boxing, with HIIT popular for fast-paced conditioning sessions.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Boxing", slug: "boxing" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Kickboxing", slug: "kickboxing" }, { name: "Self Defense", slug: "self-defense" }] },
  "brampton": { name: "Brampton", metaTitle: "Personal Trainer Brampton | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Brampton at your location.", intro: "Brampton customers frequently book Strength & Conditioning and Boxing, plus Bootcamp/HIIT for high-energy conditioning.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Boxing", slug: "boxing" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "HIIT", slug: "hiit" }, { name: "Kickboxing", slug: "kickboxing" }, { name: "Yoga", slug: "yoga" }] },
  "oakville": { name: "Oakville", metaTitle: "Personal Trainer Oakville | In-Person Training | Group Fit", metaDesc: "Book an in-person personal trainer in Oakville at your location.", intro: "Oakville customers often prefer Strength & Conditioning for steady progression, with Yoga and Calisthenics popular for mobility and bodyweight sessions.", activities: [{ name: "Strength & Conditioning", slug: "strength-and-conditioning" }, { name: "Yoga", slug: "yoga" }, { name: "Calisthenics", slug: "calisthenics" }, { name: "HIIT", slug: "hiit" }, { name: "Bootcamp", slug: "bootcamp" }, { name: "Boxing", slug: "boxing" }] },
};
