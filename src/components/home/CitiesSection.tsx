    ...
    <section className="py-20 md:py-28 bg-background" style={{ contain: "layout style" }}>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
          ...
          <PillLink to="/cities">View all cities</PillLink>
        </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 0.15, duration: 0.65, ease: [0.21, 0.47, 0.32, 0.98] }}
        >
          <Carousel
                ...
                <CarouselItem key={city.slug} className="pl-4 basis-1/2 md:basis-1/3 lg:basis-1/5">
                  ...
                  >
                    ...
                    >
                      <Link
                        to={`/cities/${city.slug}`}
                        className="group block relative aspect-[4/3] rounded-xl overflow-hidden shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-lifted)] transition-shadow duration-300"
                      >
                        <img
                          src={city.image}
                          srcSet={city.srcSet}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-3">
                          <span className="font-medium text-white text-sm group-hover:text-primary transition-colors duration-300">
                            {city.name}
                          </span>
                        </div>
                      </Link>
