        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 flex w-fit items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium text-white bg-[#25D366] hover:bg-[#1da851] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
            >
