      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <motion.div variants={fadeUp} className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            {/* Contact Us Button */}
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="mt-4 w-fit">
              <Button
                asChild
                className="bg-primary text-white hover:bg-primary/90 hover:shadow-[0_0_20px_hsl(355_78%_56%/0.4)]"
              >
            ...
            {/* WhatsApp Button */}
            <motion.a
              href="https://wa.me/14382998964?text=Hi%2C%20I%20have%20a%20question%20about%20Group%20Fit"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 flex w-fit items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-medium text-white bg-[#25D366] hover:bg-[#1da851] transition-all duration-300 hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]"
                ...
                <li key={link.name}>
                  {link.href.startsWith("http") ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white/70 text-sm hover:text-primary transition-colors hover:translate-x-1 inline-block duration-200"
                    >
                      {link.name}
                    </a>
                  ) : (
